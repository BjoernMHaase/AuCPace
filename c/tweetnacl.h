...
extern void crypto_elligator2(
	unsigned char *x1, // Result buffer of 32 bytes
	const unsigned char *r1, // input buffer
	const int numBytes // len of input buffer of up to 64 bytes.
);

extern int crypto_inverse_scalarmult(unsigned char *q, const unsigned char *n, const unsigned char *p);
